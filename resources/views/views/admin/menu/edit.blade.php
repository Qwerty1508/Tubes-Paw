                        ...
                        <form action="/admin/menus/{{ $menu->slug }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-lg me-2"></i>Perbarui Menu
                                </button>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-2"><i class="bi bi-check-circle text-success me-2"></i> Kosongkan URL gambar jika tidak ingin mengganti</li>
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (isUploadTabActive) {
            ...
            if (file) {
                e.preventDefault();
                // Simulasi upload
                alert('Simulasi: Gambar akan diupload.\n\nDi implementasi nyata, ini akan menyimpan ke server.');
                const reader = new FileReader();
        ...
        // Jika tidak ada perubahan gambar, form submit seperti biasa
    });
})();
</script>
@endpush
